        ...
        b_enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Log.i("Авторизация","Поток начал работу");
                        ...
                        Log.i("Авторизация","Поток закончил работу");
                    }
                }).start();
            }
        });
        ...
        b_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Log.i("Регистрация","Поток начал работу");
                        TH.post(new Runnable() {
                            @Override
                            public void run() {
                        ...
                        Log.i("Регистрация","Поток закончил работу");
                    }
                }).start();
            }
        });
